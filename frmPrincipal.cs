...
namespace pryBonaderoED
{
    public partial class frmPrincipal : Form
    {
        ...
        private void sQLConTextboxToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmSQLPORTEXTO frmSQLPORTEXTO = new frmSQLPORTEXTO();
            frmSQLPORTEXTO.ShowDialog();
        }

        private void sQLConComboboxToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmSQLCombo frmSQLCombo = new frmSQLCombo();
            frmSQLCombo.ShowDialog();
        }
    }
}
